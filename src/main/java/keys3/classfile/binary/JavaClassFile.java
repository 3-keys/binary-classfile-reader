...
public class JavaClassFile {
    ...
    public JavaClassFile(InputStream in) throws Exception {
        this(new ClassReader(in));
    }


    public JavaClassFile(ClassReader reader) throws Exception {
    ...
    private int readAccessFlags(ClassReader reader) throws IOException {
    ...
    private ConstantPool readConstantPool(ClassReader reader) throws IOException {
        int constantPoolCount = reader.readUint16();
        return new ConstantPool(constantPoolCount, reader);
    }

    private Member[] readMembers(ClassReader reader) throws Exception {
    ...
    private Attribute[] readAttributes(ClassReader reader) throws Exception {
    ...
    public static class ConstantPool {
        ...
        public ConstantPool(int constantPoolCount, ClassReader reader) throws IOException {
        ...
        private ConstantInfo readConstantInfo(int index, ClassReader reader) throws IOException {
        ...
        public class ConstantStringInfo implements ConstantInfo {
            ...
            public ConstantStringInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
        ...
        public class ConstantDoubleInfo implements ConstantInfo {
            ...
            public ConstantDoubleInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
        ...
        public class ConstantIntegerInfo implements ConstantInfo {
            ...
            public ConstantIntegerInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
        ...
        public class ConstantFloatInfo implements ConstantInfo {
            ...
            public ConstantFloatInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
        ...
        public class ConstantLongInfo implements ConstantInfo {
            ...
            public ConstantLongInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
                value = reader.readInt8s(8);
            }
        ...
        public class ConstantUtf8Info implements ConstantInfo {
            ...
            public ConstantUtf8Info(int index, ClassReader reader) throws IOException {
                this.index = index;
        ...
        public class ConstantClassInfo implements ConstantInfo {
            ...
            public ConstantClassInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
        ...
        public class ConstantMemberRefInfo implements ConstantInfo {
            ...
            public ConstantMemberRefInfo(ClassReader reader) throws IOException {
        ...
        public class ConstantNameAndTypeInfo implements ConstantInfo {
            ...
            public ConstantNameAndTypeInfo(int index, ClassReader reader) throws IOException {
        ...
        public class ConstantMethodTypeInfo implements ConstantInfo {
            ...
            public ConstantMethodTypeInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
                descriptorIndex = reader.readUint16();
            }
        ...
        public class ConstantMethodHandleInfo implements ConstantInfo {
            ...
            public ConstantMethodHandleInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
        ...
        public class ConstantInvokeDynamicInfo implements ConstantInfo {
            ...
            public ConstantInvokeDynamicInfo(int index, ClassReader reader) throws IOException {
                this.index = index;
    ...
    public class Attribute extends LinkedHashMap<String, Object> {
        public Attribute(int attrNameIndex, int length, ClassReader reader) throws Exception {
        ...
        private void decode(String attrName, int length, ClassReader reader) throws Exception {
            switch (attrName) {
                case "ConstantValue": {
        ...
        public class StackMapType {
            ...
            public StackMapType(ClassReader reader) throws IOException {
        ...
        public class StackMapFrame {
            ...
            public StackMapFrame(ClassReader reader) throws IOException {
        ...
        public class Annotation {
            ...
            public Annotation(ClassReader reader) throws IOException {
            ...
            public Annotation.ElementValue newElementValue(char tag, ClassReader reader) throws IOException {
    ...
    public static class ClassReader implements Closeable {
        ...
        public int readInt16() throws IOException {
            ...
            data.add(buf[0]);
            data.add(buf[1]);
            int value = (short) (buf[0] << 8 | buf[1] & 0xFF);
            return value;
        }
         ...
         * @return 16位-无符号-数组
         */
        public int[] readUint16s() throws IOException {
         ...
         * @return 8位-有符号-数组
         */
        public byte[] readInt8s(int length) throws IOException {
         ...
         * @return 8位-无符号-数组
         */
        public short[] readUInt8s(int length) throws IOException {
